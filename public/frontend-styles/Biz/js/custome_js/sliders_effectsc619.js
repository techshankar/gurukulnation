...
$(document).ready(function () {
    ...
    $(".course-section").append('<div class="modal fade" id="myModal" role="dialog">' +
        ...
        '<button type="button" class="close" data-dismiss="modal"><img src="/Biz/img/cancel2.png"></button>' +
    ...
    /*'<div class="modal-header">' +*/
        ...
        '</div>' +
        '<div class="modal-footer">'+
        '<button type="button" class="btn" id="btn_leadsubmit">Submit</button>' +
        /*'<button type="button" class="btn cls_class" data-dismiss="modal">Close</button>' +*/
        '</div></div></div></div>');
