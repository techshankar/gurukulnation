...
var count = 0;
var ddIntr = "";
var _name = $("#pp_name").val(), _mobile = $("#pp_mobile").val(), _email = "", _type = "HP", _fromWhere = "", _callRegarding = ""
var isLeadpopShow = $.cookie("LeadPop");

if (localStorage.getItem("hm_flag") != "1") {
    setTimeout(function () { $("#about_bizgurukul").show() }, 5000);
...
$("#nextBtn").click(function () {
    ...
    if (count == 1) {
        ...
        if (_fromWhere != "" && _callRegarding != "") {
            ...
            setTimeout(function () { $("#about_bizgurukul").hide() }, 4000);
