                        ...
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane tabcontent" id="">
                                <form class="form-horizontal" action="{{ route('admin.saveCourse') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label for="inputName" class="col-sm-12 col-form-label">What you will learn <span class="text-danger">(*Write your sentence and press enter button)</span>:</label>
                                            <input type="text" id="tag-input2" class="form-control" placeholder="Enter What you will learn" name="what_you_will_learn[]">
                                        </div>
                                    ...
                                    <!-- <div class="form-group row">
                                        <div class="col-lg-12">
                                        <label for="inputName" class="col-sm-12 col-form-label">Video:</label>
                                            <input type="input" class="form-control" id="inputName" placeholder="Enter Video" name="video" required>
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="file" class="form-control" name="certificate_img" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            ...
                                            <textarea name="home_page_desc" class="form-control" id="editorHomePage"></textarea>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="inputName" class="col-sm-12 col-form-label">Short Description:</label>
                                            <textarea name="short_desc" class="form-control" id="editorShortDesc"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-12 col-form-label">Description:</label>
                                        <div class="col-sm-12">
                                            <textarea name="course_description" class="form-control" id="editor"></textarea>
                                        </div>
                                    </div>
