...
<body class="sidebar-mini layout-fixed text-sm">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="{{ \URL::to('/')}}" class="brand-link bg-white" >
        <img src="{{ asset('public/dist/img/gurukul_logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Gurukul Nation</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('admin.job_applied_list')}}" class="nav-link {{ (request()->is('admin/job_applied_list*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-hdd"></i>
                <p>
                  Job Applied List 
                </p>
