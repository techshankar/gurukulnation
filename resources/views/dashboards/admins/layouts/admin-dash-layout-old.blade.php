      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
             <a href="{{ route('admin.founder')}}" class="nav-link {{ (request()->is('admin/founder*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-hdd"></i>
                <p>
                  Founder
                </p>
            ...
            <li class="nav-item">
              <a href="{{ route('admin.userlist')}}" class="nav-link {{ (request()->is('admin/userlist*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-home"></i>
                <p>
                  User List
                </p>
            ...
            <li class="nav-item">
              <a href="{{ route('admin.sub_category')}}" class="nav-link {{ (request()->is('admin/sub_category*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-home"></i>
                <p>
                  Sub Category List
                </p>
            ...
            <li class="nav-item">
              <a href="{{ route('admin.packersMoversList')}}" class="nav-link {{ (request()->is('admin/packersMoversList*')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-home"></i>
                <p>
                  Packers & Movers Order List
                </p>
              </a>
            </li> -->
            <li class="nav-item">
