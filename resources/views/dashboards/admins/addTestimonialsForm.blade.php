                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane tabcontent" id="">
                                <form class="form-horizontal" action="{{ route('admin.saveTestimonials') }}" method="POST" enctype="multipart/form-data">
                                    @csrf

                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                        <label for="inputName" class="col-sm-6 col-form-label">Name:</label>
                                            <input type="input" class="form-control" id="inputName" placeholder="Enter Name" name="title" required>
